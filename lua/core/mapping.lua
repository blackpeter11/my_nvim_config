...
local def_map = {
	...
	["n|<M-h>"] = map_cr("vertical resize -5"):with_silent(),
	["n|<M-l>"] = map_cr("vertical resize +5"):with_silent(),
	["n|<M-j>"] = map_cr("resize -2"):with_silent(),
	["n|<M-k>"] = map_cr("resize +2"):with_silent(),
	["n|<S-s>q"] = map_cmd(":wq<CR>"),
	["n|<C-q>"] = map_cmd(":Bwipeout<CR>"),
	["n|<S-q>"] = map_cmd(":q!<CR>"),
	["t|<S-q>"] = map_cu("q"),
	["n|<S-s>s"] = map_cmd(":w<CR>"),
