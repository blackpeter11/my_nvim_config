...
local plug_map = {
	...
	["n|<S-l>"] = map_cr("BufferLineCycleNext"):with_noremap():with_silent(),
	["n|<S-h>"] = map_cr("BufferLineCyclePrev"):with_noremap():with_silent(),
	...
	["n|<M-1>"] = map_cr("BufferLineGoToBuffer 1"):with_noremap():with_silent(),
	["n|<M-2>"] = map_cr("BufferLineGoToBuffer 2"):with_noremap():with_silent(),
	["n|<M-3>"] = map_cr("BufferLineGoToBuffer 3"):with_noremap():with_silent(),
	["n|<M-4>"] = map_cr("BufferLineGoToBuffer 4"):with_noremap():with_silent(),
	["n|<M-5>"] = map_cr("BufferLineGoToBuffer 5"):with_noremap():with_silent(),
	["n|<M-6>"] = map_cr("BufferLineGoToBuffer 6"):with_noremap():with_silent(),
	["n|<M-7>"] = map_cr("BufferLineGoToBuffer 7"):with_noremap():with_silent(),
	["n|<M-8>"] = map_cr("BufferLineGoToBuffer 8"):with_noremap():with_silent(),
	["n|<M-9>"] = map_cr("BufferLineGoToBuffer 9"):with_noremap():with_silent(),
	-- Packer
	...
	["n|<leader>pp"] = map_cr("PackerCompile"):with_silent():with_noremap():with_nowait(),
	...
	["n|<leader>df"] = map_cu('lua require("FTerm").toggle()'):with_noremap():with_silent(),
	["t|<leader>df"] = map_cu([[<C-\><C-n><CMD>lua require("FTerm").toggle()]]):with_noremap():with_silent(),
	["t|<CMD-S-d>"] = map_cu([[<C-\><C-n><CMD>lua require("FTerm").exit()]]):with_noremap():with_silent(),
	["n|<Leader>g"] = map_cu("lua require('FTerm').run('gitui')"):with_noremap():with_silent(),
	["n|<Leader>G"] = map_cu("Git"):with_noremap():with_silent(),
	["n|gps"] = map_cr("G push"):with_noremap():with_silent(),
	["n|gpl"] = map_cr("G pull"):with_noremap():with_silent(), -- Plugin trouble
	...
	--Plugin lazygit
	["n|gg"] = map_cr("LazyGit"):with_noremap():with_silent(),
	-- Plugin Aerial
	...
	["n|<C-w>n"] = map_cr("VTerm"):with_noremap():with_silent(),
	...
	["v|<leader>m"] = map_cr("CommentToggle"):with_silent():with_noremap(),
	-- Plugin rnvimr
	["n|<leader>ra"] = map_cu("RnvimrToggle"):with_silent():with_noremap(),
}
